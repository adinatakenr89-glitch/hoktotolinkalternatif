...
const D = {
  brand: 'HOKTOTO',
  domain: 'hoktotolinkalternatif.com',
  ...
  amphtml: 'hoktotolinkalternatif.com',
};
...
const faqs = [
  { q: 'Bagaimana cara login HOKTOTO?', a: 'Kunjungi halaman login resmi di situs resmi HOKTOTO, masukkan username dan password, lalu klik Login.' },
  { q: 'Apakah HOKTOTO aman?', a: 'Ya, kami menggunakan enkripsi SSL 256-bit dan proteksi keamanan berlapis tingkat enterprise.' },
  { q: 'Bisa akses dari smartphone?', a: 'Tentu, HOKTOTO dioptimalkan untuk semua perangkat mobile dengan tampilan responsif.' },
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>HOKTOTO Link Alternatif: Kumpulkan Koleksi Monster Unik Tanpa Batas</title>
        <meta name="description" content="HOKTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="HOKTOTO Link Alternatif: Kumpulkan Koleksi Monster Unik Tanpa Batas" />
        <meta property="og:description" content="HOKTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="HOKTOTO Link Alternatif: Kumpulkan Koleksi Monster Unik Tanpa Batas" />
        <meta name="twitter:description" content="HOKTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang." />
      ...
      <style jsx global>{`
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        body{font-family:'Barlow',sans-serif;background:#08080a;color:#d0d0d0;line-height:1.7;overflow-x:hidden}
        a{color:inherit;text-decoration:none}img{max-width:100%;display:block}
        .W{max-width:1200px;margin:0 auto;padding:0 24px}

        .topbar{background:#121215;border-bottom:1px solid rgba(160,168,184,.18);padding:6px 0;font-size:11px;color:#999;text-transform:uppercase;letter-spacing:1px}
        .topbar-inner{display:flex;justify-content:space-between;align-items:center}
        .topbar a{color:#a0a8b8;font-weight:700;transition:.2s}.topbar a:hover{opacity:.8}

        header{background:#08080a;border-bottom:1px solid rgba(160,168,184,.18);position:sticky;top:0;z-index:50}
        ...
        .logo img{width:36px;height:36px;border-radius:4px;border:2px solid #a0a8b8}
        ...
        .nav-strip a:hover,.nav-strip a.act{color:#a0a8b8;border-bottom-color:#a0a8b8}
        ...
        .btn-p{background:#a0a8b8;color:#08080a}.btn-p:hover{background:#8890a0;transform:translateY(-1px)}
        .btn-o{border:2px solid #a0a8b8;color:#a0a8b8;background:transparent}.btn-o:hover{background:rgba(160,168,184,.1)}

        .hero{background:#121215;padding:56px 0;position:relative;overflow:hidden}
        .hero::before{content:'';position:absolute;right:0;top:0;width:50%;height:100%;background:linear-gradient(270deg,rgba(160,168,184,.1),transparent)}
        .hero::after{content:'';position:absolute;left:0;bottom:0;width:100%;height:4px;background:linear-gradient(135deg,#6a7080,#a0a8b8)}
        .hero-flex{display:flex;align-items:center;gap:48px;position:relative;z-index:1}
        .hero-text{flex:1}
        .hero-text .stripe{display:inline-block;background:#a0a8b8;color:#08080a;padding:5px 20px;font-size:11px;font-weight:800;text-transform:uppercase;letter-spacing:2px;margin-bottom:18px;clip-path:polygon(0 0,100% 0,96% 100%,0 100%)}
        ...
        .hero-text .btn-hero.fill{background:#a0a8b8;color:#08080a}
        .hero-text .btn-hero.fill:hover{background:#8890a0;transform:translateY(-2px);box-shadow:0 10px 30px rgba(0,0,0,.4)}
        .hero-text .btn-hero.line{background:transparent;color:#a0a8b8;border:2px solid #a0a8b8}
        .hero-text .btn-hero.line:hover{background:rgba(160,168,184,.1)}
        ...
        .hero-img img{border-radius:4px;box-shadow:0 24px 64px rgba(0,0,0,.5);border:1px solid rgba(160,168,184,.18)}

        .stats{background:#1c1c20;border-bottom:4px solid #a0a8b8;padding:28px 0}
        .stats-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:20px;text-align:center}
        .stat-item{padding:10px 0;border-right:1px solid rgba(160,168,184,.18)}
        .stat-item:last-child{border-right:none}
        .stat-item .sv{font-size:30px;font-weight:900;color:#a0a8b8}
        .stat-item .sl{font-size:9px;color:#999;text-transform:uppercase;letter-spacing:2px;margin-top:4px;font-weight:600}

        .sec{padding:56px 0}
        .sec-alt{background:#121215}
        .sec-head{text-align:center;margin-bottom:42px}
        .sec-head .tag{display:inline-block;background:rgba(160,168,184,.1);color:#a0a8b8;padding:5px 18px;font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:2px;margin-bottom:14px;border-left:3px solid #a0a8b8}
        ...
        .art-content h3{font-size:22px;font-weight:800;margin-bottom:18px;color:#a0a8b8;text-transform:uppercase;letter-spacing:.5px}
        ...
        .art-gallery img{border-radius:4px;border:1px solid rgba(160,168,184,.18);width:100%;height:210px;object-fit:cover;transition:.3s}
        .art-gallery img:hover{border-color:#a0a8b8}
        .art-tags{display:flex;gap:8px;flex-wrap:wrap;margin-top:18px}
        .art-tag{background:rgba(160,168,184,.1);color:#a0a8b8;padding:5px 16px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;border-left:3px solid #a0a8b8}

        .feat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:16px}
        .feat-card{background:#1c1c20;border:1px solid rgba(160,168,184,.18);border-radius:4px;padding:28px;transition:.3s;border-top:3px solid transparent}
        .feat-card:hover{border-top-color:#a0a8b8;transform:translateY(-4px);box-shadow:0 12px 36px rgba(0,0,0,.3)}
        .feat-card .fi-icon{width:50px;height:50px;border-radius:4px;background:rgba(160,168,184,.1);display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:16px;border-left:3px solid #a0a8b8}
        ...
        .cta-box{background:#1c1c20;border:1px solid rgba(160,168,184,.18);border-radius:4px;padding:56px 36px;text-align:center;position:relative;overflow:hidden}
        .cta-box::before{content:'';position:absolute;top:0;left:0;right:0;height:4px;background:linear-gradient(135deg,#6a7080,#a0a8b8)}
        .cta-box::after{content:'';position:absolute;right:0;top:0;width:40%;height:100%;background:linear-gradient(270deg,rgba(160,168,184,.1),transparent)}
        ...
        .cta-box .btn-cta{background:#a0a8b8;color:#08080a;font-weight:800;padding:16px 40px;border-radius:4px;border:none;cursor:pointer;font-family:inherit;font-size:14px;text-transform:uppercase;letter-spacing:1.5px;transition:.25s}
        .cta-box .btn-cta:hover{background:#8890a0;transform:translateY(-2px);box-shadow:0 10px 30px rgba(0,0,0,.4)}

        .bnr-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}
        .bnr-card{border-radius:4px;overflow:hidden;border:1px solid rgba(160,168,184,.18);transition:.3s}
        .bnr-card:hover{transform:translateY(-4px);box-shadow:0 10px 30px rgba(0,0,0,.3);border-color:#a0a8b8}
        .bnr-card img{width:100%;height:auto}

        .faq-list{max-width:740px;margin:0 auto}
        .faq-item{background:#1c1c20;border:1px solid rgba(160,168,184,.18);border-radius:4px;padding:20px 24px;margin-bottom:10px;cursor:pointer;transition:.25s;border-left:3px solid transparent}
        .faq-item:hover{border-left-color:#a0a8b8}
        ...
        .faq-q span{color:#a0a8b8;font-size:20px;font-weight:800}
        .faq-a{margin-top:12px;color:#999;font-size:13px;line-height:1.75;border-top:1px solid rgba(160,168,184,.18);padding-top:12px;text-align:justify;text-transform:none;letter-spacing:0}

        footer{background:#121215;border-top:4px solid #a0a8b8;padding:40px 0;font-size:12px}
        .ft-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:30px;margin-bottom:24px}
        .ft-col h4{color:#a0a8b8;font-size:13px;font-weight:800;margin-bottom:14px;text-transform:uppercase;letter-spacing:1.5px}
        .ft-col a{display:block;color:#888;margin-bottom:8px;transition:.2s;font-weight:500}.ft-col a:hover{color:#a0a8b8}
        .ft-bottom{border-top:1px solid rgba(160,168,184,.18);padding-top:20px;text-align:center;color:#666;font-size:11px;text-transform:uppercase;letter-spacing:1px}
        ...
        <section className="hero"><div className="W">
          <div className="hero-flex">
            <div className="hero-text">
              ...
              <h1>HOKTOTO Link Alternatif: Kumpulkan Koleksi Monster Unik Tanpa Batas</h1>
              <p>HOKTOTO adalah situs resmi terpercaya dengan akses login cepat, keamanan SSL 256-bit, dan dukungan 24/7. Daftar gratis sekarang.</p>
              <div className="hbtns">
        ...
        <section className="sec sec-alt" id="tentang"><div className="W">
          ...
          <div className="art-row">
            <div className="art-content">
              ...
              <p>HOKTOTO hadir di situs resmi HOKTOTO dengan komitmen menghadirkan layanan digital terpercaya yang mengutamakan keamanan pengguna. Sebagaimana rumah sakit menjaga kesehatan pasien, HOKTOTO menjaga keamanan data dan kenyamanan akses setiap pengguna. Sistem keamanan berlapis dengan enkripsi SSL 256-bit melindungi setiap informasi pribadi, sementara server berperforma tinggi memastikan loading halaman dalam hitungan detik.</p>
              <div className="art-gallery">
              ...
              <p>Platform resmi HOKTOTO di situs resmi HOKTOTO dirancang dengan standar keamanan tertinggi dan antarmuka yang bersih serta intuitif. Dukungan teknis profesional tersedia 24 jam sehari, 7 hari seminggu, siap membantu setiap kendala yang Anda hadapi. Dengan uptime 99,9% dan multiple link alternatif yang selalu diperbarui, HOKTOTO memastikan Anda selalu dapat mengakses layanan tanpa gangguan dari lokasi manapun.</p>
